...
User.create(username: 'Diego', password: 'snippets', password_confirmation: 'snippets',email: 'diego@gmail.com')
User.create(username: 'Ana', password: 'xander',password_confirmation: 'xander', email: 'ana@gmail.com')
User.create(username: 'Amy', password: 'heyyyyy', password_confirmation: 'heyyyyy', email: 'nyc@gmail.com')
